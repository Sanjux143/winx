...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final CheckBox cbEnableBox64Trace = view.findViewById(R.id.CBEnableBox64Trace);
        cbEnableBox64Trace.setChecked(preferences.getBoolean("enable_box64_trace", false));
        ...
        view.findViewById(R.id.BTConfirm).setOnClickListener((v) -> {
            ...
            editor.putBoolean("enable_box64_trace", cbEnableBox64Trace.isChecked());
